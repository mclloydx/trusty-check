        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-background/70 mb-6 max-w-md">
              Your trusted partner for product verification. We connect buyers with local agents to ensure every purchase is authentic and as described.
            </p>
